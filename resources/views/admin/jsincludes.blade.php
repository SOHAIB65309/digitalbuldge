...
<script src={{asset('Admin/js/daterangepicker.js.js')}}></script>
<script src={{asset('Admin/js/jquery.stickOnScroll.js.js')}}></script>
...
<script src={{asset('Admin/js/jquery.mask.min.js.js')}}></script>
<script src={{asset('Admin/js/select2.min.js.js')}}></script>
<script src={{asset('Admin/js/jquery.steps.min.js.js')}}></script>
<script src={{asset('Admin/js/jquery.validate.min.js.js')}}></script>
<script src={{asset('Admin/js/jquery.timepicker.js.js')}}></script>
<script src={{asset('Admin/js/dropzone.min.js.js')}}></script>
<script src={{asset('Admin/js/uppy.min.js.js')}}></script>
<script src={{asset('Admin/js/quill.min.js.js')}}></script>
<script>
  $('.select2').select2({
    theme: 'bootstrap4',
  });
